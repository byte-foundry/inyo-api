...
const GraphQLTimeZone = new GraphQLScalarType({
	name: 'TimeZone',

	description:
		'A field whose value conforms to the standard IANA Time Zone Database: https://www.iana.org/time-zones.',
	...
	parseLiteral(ast) {
		if (ast.kind !== Kind.STRING) {
			throw new GraphQLError(
				`Can only validate strings as TimeZone but got a: ${ast.kind}`,
			);
		}

		if (!timezones.includes(ast.value)) {
			throw new TypeError(
